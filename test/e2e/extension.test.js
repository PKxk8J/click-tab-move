...
describe('Firefox extension E2E', () => {
  ...
  test('options page saves settings and restores them after reload', async () => {
    ...
    await setCheckboxValue('menuItems_right_global', false)
    await setCheckboxValue('menuItems_right_group', false)
    ...
    assert.equal(await (await driver.findElement(By.id('menuItems_right_global'))).isSelected(), false)
