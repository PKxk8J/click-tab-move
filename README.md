...
- Ctrl/Shift/Command クリックでタブバー上で選択済みの複数タブを、メニューの「選択済みのタブ」から移動
- メニューの「タブ・グループを選ぶ」から、選択画面でチェックしたタブ・グループを移動
- メニューの「グループ内のタブを選ぶ」から、選択画面でチェックしたグループ内タブを移動
...
選択画面では、グループのチェックボックスで「グループを選択」「グループ内の全タブを選択」「どちらも選択しない」を切り替えられます。
Ctrl/Shift/Command クリックでタブバー上で選択済みのタブは、グループ内の全タブが選ばれていてもグループではなく個別タブとして移動します。
